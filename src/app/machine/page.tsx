...
export default function MachinePage() {
  ...
  const handleCancel = () => {
    if (dispensing) return;
    const hadSelection = selectedLetter !== null;
            ...
            <div className="flex items-center gap-5">
              <div className="flex items-center gap-3 rounded-2xl bg-gradient-to-r from-slate-50 to-teal-50/50 px-5 py-3 ring-1 ring-slate-200/60">
                ...
                <div>
                  ...
                  <p className="text-lg font-extrabold text-slate-800">CHF <span className="text-teal-600">{(budget - amountSpent).toFixed(2)}</span></p>
                </div>
              </div>
